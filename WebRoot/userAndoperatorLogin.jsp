...
<head>
  ...
  <body>
    <div class="w">
        <div id="logo">
        <a href="main.jsp">
            <img src="images/img/logo3.png" alt="桃木" width="170" height="50" >
        </a>
        <b></b>
        </div>
			<span class="q-link">
                    ...
                    <div class="mc">
                        <div class="form">
                            <form id="formlogin" method="post" onsubmit="return false;">
								<input type="hidden" id="uuid" name="uuid" value="4ce9dcdf-d1f1-4d8d-9629-2dc4cde6a0f2">
                                <input type="hidden" name="eid" id="eid" value="" class="hide">
                                <input type="hidden" name="fp" id="sessionId" value="" class="hide">
                                <input type="hidden" name="_t" id="token" value="" class="hide">
                                <input type="hidden" name="loginType" id="loginType" value="" class="hide">
                                <input type="hidden" name="pubKey" id="pubKey" value="" class="hide">
                                <input type="hidden" name="zrGTNRZuAx" value="">
                    ...
                    <div class="mc">
                        ...
                        <div class="form">
                            <form id="formlogin" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="eid" id="eid" value="" class="hide">
                                <input type="hidden" name="fp" id="sessionId" value="" class="hide">
                                <input type="hidden" name="_t" id="token" value="_ntZkyxK" class="hide">
                                <input type="hidden" name="loginType" id="loginType" value="c" class="hide">
                                <input type="hidden" name="pubKey" id="pubKey" value="" class="hide">
                                <input type="hidden" name="zrGTNRZuAx" value="gvmce">
                                
                                <div class="item item-fore1">
                                    <label for="loginname" class="login-label name-label"></label>
                                    <input id="loginname" type="text" class="itxt" name="loginname" tabindex="1" autocomplete="off" placeholder="授权号/登录码">
                                    <span class="clear-btn"></span>
                                </div>
