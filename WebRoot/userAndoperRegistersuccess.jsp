...
<div id="form-header" class="header">
    <div class="logo-con">
        ...
        <div class="have-account">已有账号？ <a href="userAndoperatorsLogin.jsp">请登录</a></div>
    </div>
</div>
       <div class="logo-main">
            ...
            <button class="logo-main-lf4" id="open-btn"><a href="userAndoperatorsLogin.jsp" style="text-decoration:none;color:#fff;">立即登录</a></button>
            </div>
