    ...
    <div class="cont_login">
      ...
      <div class="cont_forms" >
        ...
        <div class="cont_form_login"> <a href="#" onClick="ocultar_login_sign_up()" ><i class="material-icons">&#xE5C4;</i></a>
          ...
          <input type="text" placeholder="用户名" data-placeholder="用户名" name="userName1" id="userName1" autocomplete="off" maxlength="15"/>
          <input type="password" placeholder="密码" data-placeholder="密码" name="password" id="pwd1" maxlength="20" autocomplete="off"/>
          <button class="btn_login" onClick="cambiar_login()"><a class="login-btn" role="submit" herf="javascript:;">提&nbsp;&nbsp;&nbsp;交</a></button>
        </div>
...
<script src="js/views/manageLogin.js"></script>
</body>
</html>