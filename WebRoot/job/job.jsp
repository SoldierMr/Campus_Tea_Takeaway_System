...
<title>招贤纳士-奶茶店加盟_奶茶加盟商_加盟奶茶连锁_西木喵奶茶品牌</title>
<meta name="description" content="西木喵品牌奶茶源自台湾知名奶茶加盟品牌。时至今日西木喵奶茶加盟商从宝岛台湾逐渐发展至中国大陆地区,目前已拥有300多家奶茶加盟连锁店。">
      ...
      <div class="topR">
        ...
        <div class="menu">
          <ul class="nav" id="nav">
           ...
           <li><a rel="nofollow" href="../job/job.jsp" class="AHover" title="加入西木喵团队"><label>Recruitment</label><span>招贤纳士</span></a></li>
         </ul>
        </div>
      </div>
    </div>
...
<div style="height:116px;" id="y"></div>
  ...
  <div class="INbanner" style="background:url(../images/img/INbanner5.jpg) top center no-repeat;"></div>
 ...
 <div class="zpBg">
   <div class="zpDiv1">
     ...
     <div class="zpDiv1R">
       <div class="zpDiv1R_title">job recruitmnt<br>招聘职位</div>
       <div class="zpDiv1R_Cont">
           &nbsp;
       </div>
     </div>
   ...
   <div class="clear"></div>
   <div class="zpDiv2">
     <div class="zpDiv2L"><span>欢迎有事业心、有梦想、有追求与有能力的<br>工作伙伴为员工提供有竞争力的薪酬和<br>无限可能的平台</span></div>
     <div class="zpDiv2R">
       <span>
         欢迎有志英才前来应聘<br>加盟热线：400-000-0000<br><br>
         微信公众号：twteamelon<br>官方微博：Teamelon西木喵<br><br>
         联系我们：<br>
华广西木喵茶饮管理有限公司<br>
Tel：0001-80000000<br>
Email：标题（应聘职位+姓名）发送至staff.hr@teamelon.com<br>
地址：广州花都区学府一号路华南理工大学广州学院C12栋112<br>
邮编：580000
       </span>
     </div>
     <div class="clear"></div>
...
<div class="foot3">粤ICP备100000000号-2 copyrighr©2016 teamelon.com all rights resrved.
</div>
<span id="cnzz_stat_icon_3464126"><a><img border="0" hspace="0" vspace="0" src="../images/img/pic1.gif"></a></span>
