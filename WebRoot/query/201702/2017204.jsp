...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>北京理工大学珠海学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/46.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>北京理工大学珠海学院店</strong></span><br>
	地址：广东省珠海市宜兴市宜兴蛟桥河步行街<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017205.jsp">北京师范大学珠海分校店</a>  &nbsp;&nbsp;下一篇：<a href="2017203.jsp">吉林大学珠海学院店</a> 
    </div>
 </div>
