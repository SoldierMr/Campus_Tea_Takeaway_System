...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东理工学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/56.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东理工学院店</strong></span><br>
	地址：广东省肇庆区创维半导体设计大厦裙楼102F<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="../201703/2017301.jsp">肇庆学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017213.jsp">广东工商职业学院店</a> 
    </div>
 </div>
