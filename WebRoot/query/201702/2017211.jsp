...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>韶关学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/53.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>韶关学院店</strong></span><br>
	地址：广东省韶关市博罗县罗阳二路11号<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017212.jsp">岭南师范学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017210.jsp">广东松山职业技术学院店</a> 
    </div>
 </div>
