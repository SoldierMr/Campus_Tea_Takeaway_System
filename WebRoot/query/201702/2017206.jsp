...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>汕头职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
  <img alt="" src="../../images/images/48.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>汕头职业技术学院店</strong></span><br>
	地址：广东省汕头市县城坡头新市场交通六横路<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017207.jsp">广东职业技术学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017205.jsp">北京师范大学珠海分校店</a> 
    </div>
 </div>
