...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>吉林大学珠海学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/45.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>吉林大学珠海学院店</strong></span><br>
	地址：广东省珠海市西樵镇官山城区江浦西路4号1座首层52号<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017204.jsp">北京理工大学珠海学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017202.jsp">深圳大学店</a> 
    </div>
 </div>
