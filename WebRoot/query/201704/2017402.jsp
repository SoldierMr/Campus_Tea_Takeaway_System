...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>南华工商学院清远校区店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/72.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>南华工商学院清远校区店</strong></span><br>
	地址：广东省清远市清平区安贞超市店B1层AZC-LLB1-13<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017403.jsp">广东碧桂园职业学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017401.jsp">清远职业技术学院店</a> 
    </div>
 </div>
