...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>东莞理工学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/74.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>东莞理工学院店</strong></span><br>
	地址：广东省东莞市松山湖科技产业园区龙湖长楹天街购物中心B-B2-22号商铺<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017405.jsp">广东科技学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017403.jsp">广东碧桂园职业学院店</a> 
    </div>
 </div>
