...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>中山市职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/80.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>中山市职业技术学院店</strong></span><br>
	地址：广东省中山市博爱七号路国瑞购物中心地下一层G-11<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017411.jsp">韩山师范学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017409.jsp">电子科技大学中山学院店</a> 
    </div>
 </div>
