...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>罗定职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/84.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>罗定职业技术学院店</strong></span><br>
	地址：广东省云浮市宜阳县城关镇红旗东路北侧新都汇1楼B06店<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="">没有了</a>  &nbsp;&nbsp;下一篇：<a href="2017413.jsp">揭阳职业技术学院店</a> 
    </div>
 </div>
