...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>电子科技大学中山学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/79.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>电子科技大学中山学院店</strong></span><br>
	地址：广东省中山市石岐区学院路东直门南大街1号来福士B1层K08号<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017410.jsp">中山市职业技术学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017408.jsp">广东药学院中山校区店</a> 
    </div>
 </div>
