...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东碧桂园职业学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/73.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东碧桂园职业学院店</strong></span><br>
	地址：广东省佛山市顺德区北滘镇碧江德云市场万象广场西木喵<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017404.jsp">东莞理工学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017402.jsp">南华工商学院清远校区店</a> 
    </div>
 </div>
