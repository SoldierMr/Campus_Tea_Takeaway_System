...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东科技学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/75.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东科技学院店</strong></span><br>
	地址：广东省东莞市东路8号北辰时代名门百货幸运时间美食广场B1层<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017406.jsp">中山大学新华学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017404.jsp">东莞理工学院店</a> 
    </div>
 </div>
