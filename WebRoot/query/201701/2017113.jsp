...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广州大学华软学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/41.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广州大学华软学院店</strong></span><br>
	地址：广东省广州市从化市南环路万达广场步行街3楼306<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017114.jsp">深圳信息职业技术学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017112.jsp">广东理工职业学院店</a> 
    </div>
 </div>
