...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广州科技职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/39.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广州科技职业技术学院店</strong></span><br>
	地址：广东省广州市白云区文华街与定阳路交叉口大学城生活广场A1-114号<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017112.jsp">广东理工职业学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017110.jsp">广东工贸职业技术学院店</a> 
    </div>
 </div>
