    ...
    <div class="top">
      ...
      <div class="topR">
        <div class="topR1">
          ...
          <a rel="nofollow" href="../../userAndoperatorRegister.jsp" class="rg">注册</a>
        </div>
        <div class="menu">
          <ul class="nav" id="nav">
...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东理工职业学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/40.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东理工职业学院店</strong></span><br>
	地址：广东省广州市白云区长风街与平阳路交汇处西北角 恒实城市广场·平阳景苑<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017113.jsp">广州大学华软学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017111.jsp">广州科技职业技术学院店</a> 
    </div>
 </div>
