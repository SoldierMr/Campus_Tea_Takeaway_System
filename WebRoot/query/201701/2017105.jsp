...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东轻工职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
  <img alt="" src="../../images/images/33.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东轻工职业技术学院店</strong></span><br>
	地址：广东省广州市海珠区胡家庙十字西北角华东万和城6-06店<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017106.jsp">广东交通职业技术学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017104.jsp">广东第二师范学院店</a> 
    </div>
 </div>
