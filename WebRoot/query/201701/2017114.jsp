...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>深圳信息职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/42.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>深圳信息职业技术学院店</strong></span><br>
	地址：广东省深圳市福田区五星百货四层南侧扶梯旁<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="../201702/2017201.jsp">南方科技大学店</a>  &nbsp;&nbsp;下一篇：<a href="2017113.jsp">广州大学华软学院店</a> 
    </div>
 </div>
