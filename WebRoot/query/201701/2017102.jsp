...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广州工商学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/30.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广州工商学院店</strong></span><br>
	地址：广东省广州市白云区城市中央佳惠超市一楼1号铺<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017103.jsp">中山大学新华学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017101.jsp">广州大学松田学院店</a> 
    </div>
 </div>
