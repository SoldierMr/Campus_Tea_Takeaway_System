...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>华南理工大学店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/2.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>华南理工大学店</strong></span><br>
	地址：广东省广州市天河区五山路二路港隆城家乐福二楼23号西木喵<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016103.jsp">暨南大学天虹店</a>  &nbsp;&nbsp;下一篇：<a href="2016101.jsp">中山大学万象时尚城店</a> 
    </div>
 </div>
