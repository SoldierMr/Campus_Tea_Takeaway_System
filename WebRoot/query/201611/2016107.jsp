...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>华南师范大学店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/7.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>华南师范大学店</strong></span><br>
	地址：广东省广州市中山大道西5号院1号裙楼“绿地缤纷城II期”B1层11号商铺<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016108.jsp">广东工业大学店</a>  &nbsp;&nbsp;下一篇：<a href="2016106.jsp">广州中医药大学店</a> 
    </div>
 </div>
