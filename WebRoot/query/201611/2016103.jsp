...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>暨南大学天虹店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/3.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>暨南大学天虹店</strong></span><br>
	地址：广东省广州市天河区黄埔大道西新湖路与西乡大道交汇处汇一城天虹商场负一楼B1004<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016104.jsp">华南农业大学百货店</a>  &nbsp;&nbsp;下一篇：<a href="2016102.jsp">华南理工大学店</a> 
    </div>
 </div>
