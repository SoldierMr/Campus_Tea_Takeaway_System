...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东医学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/12.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东医学院店</strong></span><br>
	地址：天广东省湛江市霞山区文明东路北侧新都汇1楼B06店<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016113.jsp">广东海洋大学店</a>  &nbsp;&nbsp;下一篇：<a href="2016111.jsp">广东商学院店</a> 
    </div>
 </div>
