...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>中山大学万象时尚城店</h1></div>
...
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>中山大学万象时尚城店</strong></span><br>
	地址：广东省广州市番禺区新港西路135号<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016102.jsp">华南理工大学店</a>  &nbsp;&nbsp;下一篇：<a href="">没有了</a> 
    </div>
 </div>
