...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东工业大学店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/8.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东工业大学店</strong></span><br>
	地址：广东省广州市番禺区广州大学城环西路永旺梦乐城4楼432A号铺<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016109.jsp">广东外语外贸大学店</a>  &nbsp;&nbsp;下一篇：<a href="2016107.jsp">华南师范大学店</a> 
    </div>
 </div>
