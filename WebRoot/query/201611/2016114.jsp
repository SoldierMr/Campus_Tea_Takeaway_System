...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>仲恺农业工程学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/14.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>仲恺农业工程学院店</strong></span><br>
	地址：广东省广州市海珠区东沙新中路281号衡悦广场15栋75铺<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="../201612/2016201.jsp">广州药学院店</a>  &nbsp;&nbsp;下一篇：<a href="2016113.jsp">广东海洋大学店</a> 
    </div>
 </div>
