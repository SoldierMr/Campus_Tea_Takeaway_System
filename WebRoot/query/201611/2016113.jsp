...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东海洋大学店</h1></div>
 ...
 <div class="pageTxt">
 <img alt="" src="../../images/images/13.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东海洋大学店</strong></span><br>
	地址：广东省湛江市湖光岩东蛟桥河步行街<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016114.jsp">仲恺农业工程学院店</a>  &nbsp;&nbsp;下一篇：<a href="2016112.jsp">广东商学院店</a> 
    </div>
 </div>
