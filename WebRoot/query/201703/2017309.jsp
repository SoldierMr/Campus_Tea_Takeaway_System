...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>惠州学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/65.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>惠州学院店</strong></span><br>
	地址：广东省惠州市惠东区解放路人民北路2026号鸿展广场一楼一横街23铺<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017310.jsp">梅州职业技术学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017308.jsp">惠州经济职业技术学院店</a> 
    </div>
 </div>
