...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东石油化工学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/62.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东石油化工学院店</strong></span><br>
	地址：广东省茂名市茂东区梅林一村家乐福一楼<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017307.jsp">惠州城市职业学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017305.jsp">茂名职业技术学院店</a> 
    </div>
 </div>
