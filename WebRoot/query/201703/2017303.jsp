...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>江门职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/59.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>江门职业技术学院店</strong></span><br>
	地址：广东省江门市新会区巴登村57栋3号店<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017304.jsp">五邑大学店</a>  &nbsp;&nbsp;下一篇：<a href="2017302.jsp">广东南方职业学院店</a> 
    </div>
 </div>
