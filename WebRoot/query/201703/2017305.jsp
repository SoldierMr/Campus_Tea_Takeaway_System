...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>茂名职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
  <img alt="" src="../../images/images/61.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>茂名职业技术学院店</strong></span><br>
	地址：广东省茂名市茂南区文明北路上沙中心椰树村1巷1-3号<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017306.jsp">广东石油化工学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017304.jsp">五邑大学店</a> 
    </div>
 </div>
