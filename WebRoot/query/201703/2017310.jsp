...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>梅州职业技术学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/66.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>梅州职业技术学院店</strong></span><br>
	地址：广东省梅州市梅县庄北里14号华联天时名苑购物中心F3-06B<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017311.jsp">嘉应学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017309.jsp">惠州学院店</a> 
    </div>
 </div>
