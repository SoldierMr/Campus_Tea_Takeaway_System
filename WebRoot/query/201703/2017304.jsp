...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>五邑大学店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/60.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>五邑大学店</strong></span><br>
	地址：广东省江门市新会东门街道东门中路2088号温莎广场负一层B1-13号 <br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2017305.jsp">茂名职业技术学院店</a>  &nbsp;&nbsp;下一篇：<a href="2017303.jsp">江门职业技术学院店</a> 
    </div>
 </div>
