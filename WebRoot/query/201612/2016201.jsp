...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广州药学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/15.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广州药学院店</strong></span><br>
	地址：广东省广州市番禺区碧海中心区新湖路与西乡大道交汇处汇一城天虹商场负一楼B1004<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016202.jsp">广州体育学院店</a>  &nbsp;&nbsp;下一篇：<a href="../201611/2016114.jsp">仲恺农业工程学院店</a> 
    </div>
 </div>
