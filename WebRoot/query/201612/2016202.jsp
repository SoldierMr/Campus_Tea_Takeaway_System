...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广州体育学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/16.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广州体育学院店</strong></span><br>
	地址：广东省广州市番禺区西四环南路资和信百货地下一层B138号<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016203.jsp">广州美术学院店</a>  &nbsp;&nbsp;下一篇：<a href="2016201.jsp">广州药学院店</a> 
    </div>
 </div>
