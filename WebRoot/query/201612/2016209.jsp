...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东警官学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/23.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东警官学院店</strong></span><br>
	地址：广东省广州市天河区舜新中路281号衡悦广场15栋75铺<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016210.jsp">广东金融学院店</a>  &nbsp;&nbsp;下一篇：<a href="2016208.jsp">广州大学店</a> 
    </div>
 </div>
