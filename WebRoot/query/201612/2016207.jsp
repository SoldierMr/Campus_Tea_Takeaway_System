...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>广东白云学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/21.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>广东白云学院店</strong></span><br>
	地址：广东省广州市白云区香港城商场西木喵商铺<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016208.jsp">广州大学店</a>  &nbsp;&nbsp;下一篇：<a href="2016206.jsp">广东财经大学店</a> 
    </div>
 </div>
