...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>中山大学南方学院店</h1></div>
 ...
 <div class="pageTxt">
   <img alt="" src="../../images/images/27.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>中山大学南方学院店</strong></span><br>
	地址：广东省广州市天河区县城关镇红旗东路北侧新都汇1楼B06店<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016214.jsp">广东财经大学华商学院店</a>  &nbsp;&nbsp;下一篇：<a href="2016212.jsp">华南理工大学广州学院店</a> 
    </div>
 </div>
