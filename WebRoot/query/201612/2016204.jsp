...
<div style="height:116px;" id="y"></div>
 ...
 <div class="shopsTop">
   <div class="title2" style="margin: 80px auto 20px"><h1>星海音乐学院店</h1></div>
 ...
 <div class="pageTxt">
  <img alt="" src="../../images/images/18.jpg">
<p>
	<span style="font-size:16px;"><span style="font-size:18px;"><strong>星海音乐学院店</strong></span><br>
	地址：广东省广州市番禺区环河北路168号SM城市广场A2042d(西木喵，自由人影城西20米)<br>
	营业时间：10:00-21:00</span></p>

   <div class="clear"></div>
    <div id="page">
       上一篇：<a href="2016205.jsp">广东技术师范学院店</a>  &nbsp;&nbsp;下一篇：<a href="2016203.jsp">广州美术学院店</a> 
    </div>
 </div>
