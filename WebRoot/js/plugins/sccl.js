...
function addIframe(cur){
	...
	if (!isHas) {
		...
		var iframeright ="<div class='layout-main-opt'></div>";
		...
		$(".layout-main-body").find("div.layout-main-opt").hide().parents(".layout-main-body").append(iframeright);
...
$(document).on("click",".layout-side-arrow",function(){
	if($(".layout-side").hasClass("close")){
		...
		$(".layout-main-opt").removeClass("full-pages");
		...
		$(".layout-main-opt").addClass("full-pages");
		$(this).addClass("close");
...
$(function(){
	...
	var menu1 = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
					{"id":"2","name":"账户管理","parentId":"1","url":"","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
						{"id":"3","name":"个人资料","parentId":"2","url":"presonalProfile.jsp","icon":"&#xe608;","order":"1","isHeader":"0","childMenus":""},
						{"id":"4","name":"修改密码","parentId":"2","url":"modifyPassword.jsp","icon":"&#xe609;","order":"1","isHeader":"0","childMenus":""},
						{"id":"5","name":"我的收藏","parentId":"2","url":"MyCollection.jsp","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"6","name":"交易管理","parentId":"1","url":"","icon":"&#xe601;","order":"1","isHeader":"0","childMenus":[
						{"id":"7","name":"我的订单","parentId":"6","url":"MyOrder.jsp","icon":"&#xe603;","order":"1","isHeader":"0","childMenus":""},
						{"id":"8","name":"收货地址","parentId":"6","url":"deliveryAddress.jsp","icon":"&#xe607;","order":"1","isHeader":"0","childMenus":""}
						
					]},
					{"id":"9","name":"订单管理","parentId":"1","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
						{"id":"10","name":"已付款","parentId":"10","url":"home4.html","icon":"&#x2707;","order":"1","isHeader":"0","childMenus":""},
						{"id":"11","name":"未付款","parentId":"10","url":"home5.html","icon":"&#x2709;","order":"1","isHeader":"0","childMenus":""}
